...
{
    public class ShiftOpenedValidator : IValidator<OpenShiftDTO, ValidationContext>
    {
        public void Validate(OpenShiftDTO closeShiftDTO, ISession session, ValidationContext validationContext)
        {
